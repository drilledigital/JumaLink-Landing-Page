  ...
  <div class="hero-content container">
    ...
    <div class="store-buttons">
      ...
      <!-- <a href="#contact" class="store-btn" aria-label="Get it on Google Play">
        ...
        >
          <path
            d="M3 20.5v-17c0-.83.52-1.28 1-1.5l10 10L4 22c-.48-.22-1-.67-1-1.5zM16 12L6.27 2.27l12.18 7.03L16 12zm-3.77 1.23L5.06 22.46l12.18-7.03-4.01-2.2zM21 12c0 .5-.27.87-.75 1.13L17.5 12l2.75-1.13c.48.26.75.63.75 1.13z"
          />
        </svg>
        <div class="store-text">
